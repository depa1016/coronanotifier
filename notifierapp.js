...
app.post('/notify', (req, res) => {
  ...
  db.serialize(function() {
     db.run('CREATE TABLE if not exists contactpeopletable (contact_address_city TEXT, contact_address_country TEXT, contact_address_housenumber INTEGER, contact_address_plz INTEGER, contact_address_street TEXT, contact_firstname TEXT, contact_lastname TEXT, contact_has_been_notified INTEGER, contact_mail_address TEXT UNIQUE, contact_telephone_number_1 TEXT, contact_telephone_number_2 TEXT, contact_telephone_number_3 TEXT)');
